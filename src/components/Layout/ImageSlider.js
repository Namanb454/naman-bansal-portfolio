...
const cards = [
    ...
    { url: 'projects/ModelVerse.jpg', title: 'Model Verse', description: 'Led the development of an AI Models web application, driving a substantial 35% boost in online sales. Successfully integrated and optimized features with Firebase, resulting in a 20% increase in user engagement.', link: 'https://model-verse-ai.vercel.app/', delay: 300 },
    {
